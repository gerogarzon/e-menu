    ...
    <>
      ...
      <div className="sobrenos-container">
        <Card  className="sobreNosotros-items"style={{ width: "18rem" }}>
         ...
         <Card className="sobreNosotros-items" style={{ width: "18rem" }}>
          <Card.Img className="card-imagen" variant="top" src={ivan} alt="creator image"/>
          <Card.Body>
            <Card.Title>Ivan Roldan</Card.Title>
            <Card.Text>
            Tengo más de 10 años de experiencia profesional. Tengo experiencia en finanzas y gestión de programas. En los últimos años me he especializado en generación de leads y manejo masivo de datos para generar ventas y nuevas oportunidades de negocio.Tengo pasión por la tecnología y esto me llevó a hacer un Bootcamp para convertirme en desarrollador Full Stack. Estoy buscando mi próxima oportunidad de trabajo.
            </Card.Text>
          </Card.Body>         
          <Card.Body className="card-footer">
